# ECS Workload Modernization - Main Terraform Configuration
# This configuration provisions the core infrastructure for 10 legacy applications
...
provider "aws" {
  ...
  default_tags {
    tags = {
      Project     = "ECS-Workload-Modernization"
